...
#numbers below are out of order because its best to first define methods
#then actually create the script that uses the methods

#this method accepts the birthdate as an argument and determines the BPN
#the BPN is the return value
...
when 3
  message = "Your numerology numer is #{birth_path_num}.
...
puts "What is your birthday? Please write it in MMDDYYYY format"
